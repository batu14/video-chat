...
import { closeCreateRoomModal } from '../../store/features/modalSlice'
...
const CreateRoomModal = ({ onCreateRoom }: CreateRoomModalProps) => {
    const dispatch = useDispatch()
    const isOpen = useSelector((state: RootState) => state.modal.isCreateRoomOpen)
    ...
    return (
        ...
        >
            <div 
                ...
                onClick={() => dispatch(closeCreateRoomModal())}
            />
            ...
            <div className={`relative bg-white dark:bg-gray-800 rounded-2xl p-8 w-full max-w-md mx-4 shadow-xl transform ${
                ...
                <h2 className='text-2xl font-bold mb-6 text-gray-800 dark:text-white'>Create New Room</h2>
